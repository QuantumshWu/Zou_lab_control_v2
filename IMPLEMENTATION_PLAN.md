...
- qCMOS SLM Feedback follow-up：`COMPLETE / SWEEP COMPLETE` — phase在shot前发布；真实全site ratio与显式`observable_uniformity_history`分离。用户真实Calibration 23→Target 35 site的100-shot链以`23→26→29→32→32→33→35`恢复loading，并在candidate 7以全阵列ratio `1.098487` accepted；每轮phase内容不同。
