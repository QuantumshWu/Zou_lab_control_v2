...
- Strong-aberration Simulation follow-up：`IMPLEMENTED` — 默认pupil wavefront在FFT前加入固定高阶phase ripple；无far-field gain mask。均匀35-site Target自然产生3个missing trap和1个低于500 µK的zero-loading trap；可加载site的conditional bright-dark ratio约4.12。旧测试手工`weight=0.1`已删除。
