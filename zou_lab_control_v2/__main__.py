...
TOOLS = {
    ...
    #: The camera server, started on the machine the camera is cabled to; the
    #: operator's machine then installs it as an ordinary camera.remote device.
    "camera_server": "zlc_atom.devices.camera.remote",
