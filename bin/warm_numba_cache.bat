...
rem zlc_plot/_kernel_cache.py -- this used to guess the same path a
rem second time, so moving it needed both to be edited or the warmer
rem filled a directory nothing read.  When the cache already holds
