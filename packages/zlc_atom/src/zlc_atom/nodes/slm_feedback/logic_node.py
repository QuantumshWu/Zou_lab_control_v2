...
SLM_FEEDBACK_SCHEMA = AuthoringSchema(
    (
        ...
        AuthoringField(
            "shots_per_candidate", "int", "qCMOS shots per candidate", 2000, minimum=10
        ),
        AuthoringField(
            "validation_shots", "int", "Independent qCMOS validation shots", 40000, minimum=10
        ),
...
LOGIC_NODE = LogicNodeDescriptor(
    ...
    device_requirements=(
        ...
        DeviceRequirement("sequencer.streamer", "sequencer", DeviceAccess.EXCLUSIVE),
        DeviceRequirement("slm.phase", "slm", DeviceAccess.EXCLUSIVE),
    ),
    build=_build,
