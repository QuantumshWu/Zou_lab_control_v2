...
for _name in (
    ...
    "FluentFrame", "FluentOverlayFrame", "FluentPopup", "show_fluent_popup_for_anchor",
    ...
    "FluentSwitch", "FluentTriSwitch", "fluent_switch_width", "fluent_spinbox_stylesheet", "FluentSpinBox", "FluentInputDialog", "FluentCardDialog",
...
for _name in (
    "ACCENT", "ACCENT_TINT", "SELECTION_EDGE", "API_VIOLET", "API_VIOLET_DARK", "AXIS_GROUP_COLORS", "BG",
