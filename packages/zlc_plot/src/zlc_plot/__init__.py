...
_EXPORTS = {
    ...
    "figure_plot_recipe": ("zlc_plot.figure_artifact", "figure_plot_recipe"),
    ...
    "PulseLoopMarker": ("zlc_plot.primitives", "PulseLoopMarker"),
    "PulsePeriodMark": ("zlc_plot.primitives", "PulsePeriodMark"),
