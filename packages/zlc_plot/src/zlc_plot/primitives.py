...
class ImagePointOverlay:
    ...
    def statuses_for(
        ...
        # Only Repeat/Point identify the image's acquisition cell. Its pixels
        # and this status Dataset's sites are distinct atomic data axes.
        for ref, coordinate in projection_scope(
            schema, spec, domains=(AxisDomain.REPEAT, AxisDomain.POINT),
        ):
