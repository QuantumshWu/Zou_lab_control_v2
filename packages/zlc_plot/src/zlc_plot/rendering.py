    ...
    def save(self, path: str | Path | BytesIO, *, dpi: float | None = None, **kwargs: Any) -> None:
        ...
        try:
            ...
            with style_context(self.style):
                ...
                # was the PREVIOUS revision's picture. All images, including
                # lazy primary/focused fronts, materialize their current
                # prepared inputs through the same owner first. The final
