...
当前用户边界：Milestone 1–4、M4 cleanup与通用indexed/capacity-one performance follow-up均已完成；同harness publication→main P50/P95 338/435→131/163 ms，Rolling 339/435→191/224 ms，source primary index连续且render逐像素不变。下一步是M5；M5完成时若本地时间不晚于15:30才开始M6。未授权任何真实hardware、program或flash。
